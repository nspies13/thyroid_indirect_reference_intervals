...
file_path <- "C:/Users/yanch/OneDrive - Washington University in St. Louis/clin_chem/01_research/07_indirect_ri/outpatient.xlsx"


raw_data_2016 <- readxl::read_xlsx(file_path, sheet = "2016") |> select(-RESULT_ASCII, -RESULT_ALPHA)
raw_data_2017 <- readxl::read_xlsx(file_path, sheet = "2017") |> select(-RESULT_ASCII, -RESULT_ALPHA)
raw_data_2018 <- readxl::read_xlsx(file_path, sheet = "2018") |> select(-RESULT_ASCII, -RESULT_ALPHA)
raw_data_2019 <- readxl::read_xlsx(file_path, sheet = "2019") |> select(-RESULT_ASCII, -RESULT_ALPHA)
raw_data_2020 <- readxl::read_xlsx(file_path, sheet = "2020") |> select(-RESULT_ASCII, -RESULT_ALPHA)
raw_data_2021 <- readxl::read_xlsx(file_path, sheet = "2021") |> select(-RESULT_ASCII, -RESULT_ALPHA)
...
data_filled <- 
  ...
  fill(tsh, t4_free, t3_free, .direction = "downup") |> 
...
ri_tsh_of_normal_t4 <- findRI(data_filled_with_normal_flags |> dplyr::filter(t4_normal) |> drop_na(tsh) |> pluck("tsh"), NBootstrap = 30, model = "modBoxCox", seed = 12345)
...
ri_tsh_of_normal_t4 |> write_rds("C:/Users/yanch/OneDrive - Washington University in St. Louis/clin_chem/01_research/07_indirect_ri/thyroid_indirect_reference_intervals/results/ri_tsh_of_normal_t4.rds")
ri_t4_of_normal_tsh |> write_rds("C:/Users/yanch/OneDrive - Washington University in St. Louis/clin_chem/01_research/07_indirect_ri/thyroid_indirect_reference_intervals/results/ri_t4_of_normal_tsh.rds")
...
ri_tsh_addbacks |> write_rds("C:/Users/yanch/OneDrive - Washington University in St. Louis/clin_chem/01_research/07_indirect_ri/thyroid_indirect_reference_intervals/results/ri_tsh_addbacks.rds")
ri_t4_addbacks |> write_rds("C:/Users/yanch/OneDrive - Washington University in St. Louis/clin_chem/01_research/07_indirect_ri/thyroid_indirect_reference_intervals/results/ri_t4_addbacks.rds")
...
ggsave("C:/Users/yanch/OneDrive - Washington University in St. Louis/clin_chem/01_research/07_indirect_ri/thyroid_indirect_reference_intervals/figures/ri_t4_dist_plots.png", width = 18, height = 12, dpi = 600, bg = "white")
